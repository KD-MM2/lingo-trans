import type { LanguageInfo } from '@src/types/language';
...
function resolveLanguageLabel(value: string, options?: { preferChineseName?: boolean }): string {
    if (!value) return '';
...
export { LANGUAGE_LOOKUP, CHINESE_LANGUAGE_CODES, SUPPORTED_LANGUAGES, findLanguageInfo, resolveLanguageLabel };
